...
export class WeixinChannelsAdapter extends PlatformAdapter {
  ...
  async publish(
    ...
    try {
      ...
      return {
        success: true,
        platformPostId: 'weixin-channels-' + Date.now(),
        platformUrl: 'https://channels.weixin.qq.com',
      };
    } catch (error: any) {
