...
Write-Host "`n[2/5] Checking remote directory structure..." -ForegroundColor Yellow
ssh $sshTarget @"
...
Write-Host "`n[3/5] Checking Node.js and PM2..." -ForegroundColor Yellow
ssh $sshTarget @"
...
Write-Host "`n[4/5] Checking Nginx configuration..." -ForegroundColor Yellow
ssh $sshTarget @"
...
Write-Host "`n[5/5] Checking local configuration files..." -ForegroundColor Yellow
$configFiles = @(
    ".\backend\.env.local",
    ".\backend\.env.remote",
    ".\ecosystem.config.js"
