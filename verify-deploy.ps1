...
# ─── 检查 1：本地 Git 配置 ───────────────────────────────────────────────────
Write-Host "`n[1/6] 检查本地 Git 配置..." -ForegroundColor Cyan
...
# ─── 检查 2：.gitignore ──────────────────────────────────────────────────────
Write-Host "`n[2/6] 检查 .gitignore..." -ForegroundColor Cyan
...
# ─── 检查 3：部署脚本 ────────────────────────────────────────────────────────
Write-Host "`n[3/6] 检查部署脚本..." -ForegroundColor Cyan

$deployFiles = @("deploy.ps1", "setup-server-git.sh", ".github/workflows/deploy.yml")
...
if ((Test-Path "deploy.ps1") -and (Test-Path "setup-server-git.sh")) {
...
# ─── 检查 4：SSH 连接 ────────────────────────────────────────────────────────
Write-Host "`n[4/6] 检查 SSH 连接..." -ForegroundColor Cyan
...
# ─── 检查 5：服务器 Git 配置 ─────────────────────────────────────────────────
Write-Host "`n[5/6] 检查服务器 Git 配置..." -ForegroundColor Cyan
...
# ─── 检查 6：GitHub Actions Secrets ──────────────────────────────────────────
Write-Host "`n[6/6] 检查 GitHub Actions 配置..." -ForegroundColor Cyan
